Feature: Skills Parsing
  ...
  Given a skill file at "dataset/markdown/skills/sample-skill/SKILL.md"
...
Scenario: SC2 - markdown links should be followed and parsed
  Given a parsed skill from "dataset/markdown/skills/sample-skill/SKILL.md"
...
Scenario: SC4 - reference should be parsed
  Given a skill dataset root at "dataset/markdown/skills/sample-skill"
