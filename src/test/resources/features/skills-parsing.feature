Feature: Skills Parsing
  ...
  Scenario: SC1 - skill headers should be parsed name, description, dependency, mcp servers, llms
    Given a skill file at "dataset/markdown/skills/implements_features_file/SKILL.md"
  ...
  Scenario: SC2 - markdown links should be followed and parsed
    Given a parsed skill from "dataset/markdown/skills/implements_features_file/SKILL.md"
  ...
  Scenario: SC4 - reference should be parsed
    Given a skill dataset root at "dataset/markdown/skills/implements_features_file"
